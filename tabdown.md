 ...
 * [Safari Extension](https://github.com/WangFenjin/tabdown/raw/master/release/tabdown.safariextz)
...
Let's get into some examples (You can always access this doc if you empty the content and then open a new tab):
...
- [x] This is completed
- [ ] You can only complete a task in markdown file
